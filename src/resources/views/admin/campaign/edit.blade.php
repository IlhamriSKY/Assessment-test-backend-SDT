                     ...
                     <div class="col-xl-9 order-xl-1 order-2">
                        <div class="form-wrapper">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-item">
                                        <label class="form-label">{{ translate('Name')}}  <sup class="text-danger">*</sup></label>
                                        <input class="form-control campaign-name" type="text" name="name" placeholder="{{translate('Enter Name')}}" value="{{$campaign->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-item">
                                        ...
                                        <select class="form-select campaign-status" name="status" id="">
                                        ...
                                        <div class="form-item">
                                            ...
                                            <select class="form-control keywords" name="group_id[]" id="group_id" multiple="multiple">
                                                ...
                                                @foreach($groups as $group)
                                                    <option
                                                    @if (old("group_id")){{ (in_array($group->id, old("group_id")) ? "selected":"") }}@endif
                        ...
                        @endif
                                ...
                                <div>
                                    @if($channel == \App\Models\Campaign::SMS)
                                        <div class="form-item mb-4">
                                            <label class="form-label">{{ translate('Select SMS Type')}} <sup class="text-danger">*</sup></label>
                                    ...
                                    <div class="form-item">
                                        <label class="form-label">{{translate('Write Message')}} <sup class="text-danger">*</sup></label>
                                        @if($channel == \App\Models\Campaign::WHATSAPP)
                                            ...
                                            <div class="custom--editor">
                                                <div class="speech-to-text" id="messageBox">
                                                    <textarea class="form-control message" name="message" id="message" placeholder="{{ translate('Enter SMS Content &  For Mention Name Use ')}}@php echo "{{". 'name' ."}}"  @endphp" aria-describedby="text-to-speech-icon">{{$campaign->body}}</textarea>
                                        ...
                                        @elseif($channel == \App\Models\Campaign::SMS)
                                            <div class="speech-to-text" id="messageBox">
                                                <textarea class="form-control message" name="message" id="smsmessage" placeholder="{{ translate('Enter SMS Content &  For Mention Name Use ')}}@php echo "{{". 'name' ."}}"  @endphp" aria-describedby="text-to-speech-icon">{{$campaign->body}}</textarea>
                                                <span class="voice-icon" id="text-to-speech-icon">
                            ...
                            <div class="form-wrapper">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        ...
                                        <input type="number" id="repeatNumber" class="form-control repeat-unit" value="{{$campaign->schedule?->repeat_number}}" name="repeat_number" required>
                                    </div>
                            ...
                            <button type="submit" class="i-btn primary--btn btn--lg">{{translate("Update")}}</button>
                     </div>
...
<script>
	(function($){
		...
		if("{{$channel}}" == "{{\App\Models\Campaign::WHATSAPP}}"){
            ...
            var campaignData = @json($campaign);
