...
<section>
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{__($channel)}} {{ translate('Campaign Info')}}</h4>
                ...
                <div class="row g-4">
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="file-tab">
                                ...
                                <div class="form-item mb-4">
                                    <label class="form-label" for="name">{{ translate('Campaign Name')}} <sup class="text-danger">*</sup></label>
                                    <input class="form-control campaign-name" type="text" id="name" name="name" placeholder="{{translate('Enter Name')}}" value="{{old('name')}}">
                                </div>
                                        ...
                                        <div class="form-item">
                                            ...
                                            <select class="form-select keywords" name="group_id[]" id="group_id" multiple="multiple">
                                                ...
                                                @foreach($groups as $group)
                                                    <option @if (old("group")){{ (in_array($group->id, old("group")) ? "selected":"") }}@endif value="{{$group->id}}">{{$group->name}}</option>
                                                @endforeach
                                            </select>
                                            <div class="form-text">
                                ...
                                <div class="row g-4">
                                    <div class="col-xl-4 col-md-6 ">
                                        <div class="form-item ">
                                            ...
                                            <input type="text"  value="{{old("subject")}}" name="subject" id="subject" class="form-control mail-subject" placeholder="{{ translate('Write email subject here')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-md-6 ">
                                        <div class="form-item ">
                                            ...
                                            <input class="form-control mail-send-from" value="{{old("from_name")}}" placeholder="{{ translate('Sender Name (Optional)')}}" type="text" name="from_name" id="from_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-md-6 ">
                                        <div class="form-item ">
                                            ...
                                            <input class="form-control mail-send-email" value="{{old("reply_to_email")}}" type="email" placeholder="{{ translate('Reply To Email (Optional)')}}" name="reply_to_email" id="reply_to_email">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="mb-3">
                                    @if($channel == \App\Models\Campaign::SMS)
                                        <div class="form-item mb-4 message-type">
                                            ...
                                            <div class="radio-buttons-container">
                                                <div class="radio-button">
                                                    <input class="radio-button-input" {{old("smsType") == "plain" ?'checked' :"" }} type="radio" name="smsType" id="smsTypeText" value="plain" checked="">
                                                    <label for="smsTypeText" class="radio-button-label"><span class="radio-button-custom"></span>{{ translate('Text')}}</label>
                                                </div>

                                                <div class="radio-button">
                                                    <input  class="radio-button-input" {{old("smsType") == "unicode" ?'checked' :"" }} type="radio" name="smsType" id="smsTypeUnicode" value="unicode">
                                                    <label for="smsTypeUnicode" class="radio-button-label"><span class="radio-button-custom"></span>{{ translate('Unicode')}}</label>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-item">
                                        <label class="form-label" for="sms-message">{{ translate('Write Message')}} <sup class="text-danger">*</sup>
                                        </label>
                                        @if($channel == \App\Models\Campaign::WHATSAPP)
                                            <div class="my-2 d-flex flex-wrap align-items-center gap-2">
                                                ...
                                                <a href="javascript:void(0)" class="i-btn info--btn btn--sm ms-auto" data-bs-toggle="modal" data-bs-target="#template-data">{{ translate('Use Template')}}</a>
                                            </div>
                                        ...
                                        @elseif($channel == \App\Models\Campaign::SMS)
                                            <div class="speech-to-text" id="messageBox">
                                                <textarea class="form-control message" name="message" id="sms-message" placeholder="{{ translate('Enter SMS Content &  For Mention Name Use ')}}@php echo "{{". 'name' ."}}"  @endphp" aria-describedby="text-to-speech-icon">{{old('message')}}</textarea>
                                                <span class="voice-icon" id="text-to-speech-icon">
                                                    <i class='fa fa-microphone text-to-speech-toggle'></i>
                                                </span>
                                            </div>
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="row g-4">
                                <div class="col-xl-4 col-md-6 ">
                                    ...
                                    <input type="datetime-local" value= "{{old("schedule_date")}}" name="schedule_date" id="schedule_date" class="form-control schedule-date" required="">
                                </div>

                                <div class="col-xl-4 col-md-6">
                                    <label for="repeatNumber" class="form-label">{{translate('Repeat Every')}}   <sup class="text-danger">*</sup></label>
                                    <input type="number" id="repeatNumber" class="form-control repeat-unit" value="{{old('repeat_number')}}" name="repeat_number" required>
                                </div>

                                <div class="col-xl-4 col-md-6 ">
                                    <label for="repeat-time" class="form-label">{{translate('Repeat in')}}   <sup class="text-danger">*</sup></label>
                    ...
                    <div class="note-container col-xl-3 order-xl-2 order-1 d-xl-block d-none">
                        <div class="note">
                            ...
                            <p class="d-none campaign-name-note note-message">{{translate("You can add your own desired campaign name with this 'Campaign Name' input field.")}}</p>
                        ...
                        @if($channel == \App\Models\Campaign::SMS && $general->sms_gateway == 1)
                            <div class="form-wrapper select-sms-gateway mt-3">
                                ...
                                <div class="sms-gateway select-sms-gateway sms-gateways mt-4 d-none">
	...
	(function($){
        ...
        $(document).ready(function () {
            ...
            $('.mail_gateway_type').change(function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('admin.gateway.select2')}}",
                    data:{
                        'type' : selectedType,
                    },
                    dataType: 'json',
		...
		function  appendTemplate(){
			$.ajax({
				method:"GET",
				url:"{{ route('admin.template.email.list.user') }}",
				dataType:'json'
			}).then(response=>{
