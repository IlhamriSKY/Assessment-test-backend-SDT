        ...
        <div class="topbar-right">
            <div class="profile_notification">
                ...
                <div class="d-lg-flex align-items-center gap-4 me-2 d-none">
                    ...
                    {{-- <a href="{{route('admin.report.transaction.index')}}" class="header-menu"><i class="las la-file-alt"></i> {{translate('Transactions & Reports')}}</a> --}}
                    {{-- <div class="header-menu"><i class="las la-cog"></i> <span>{{translate('General Settings')}} <i class="las la-angle-down"></i></span>
