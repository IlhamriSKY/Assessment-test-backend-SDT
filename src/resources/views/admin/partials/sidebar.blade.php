    ...
    <div class="sidebar-menu-container" data-simplebar>
        <ul class="sidebar-menu">
            ...
            {{-- <li class="sidebar-menu-item">
             ...
             <li class="sidebar-menu-title" data-text="{{ translate('Email Activities')}}">{{ translate('Email Activities')}}</li>
             @php
         ...
         <li class="sidebar-menu-item">
            ...
            <li class="sidebar-menu-title" data-text="{{ translate('Gateway')}}">{{ translate('Gateway')}}</li>
            ...
            <li class="sidebar-menu-title" data-text="{{ translate('Settings')}}">{{ translate('Settings')}}</li>
