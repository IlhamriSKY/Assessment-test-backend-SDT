                                ...
                                <div class="file-tab">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="group-tab-pane" role="tabpanel" aria-labelledby="group-tab" tabindex="0">
                                            <div class="form-item">
                                                <label for="email_group_id" class="form-label">{{ translate('From Group')}}</label>

                                                <select class="form-select keywords" name="email_group_id[]" id="email_group_id" multiple="multiple">
                                        ...
                                        <div class="tab-pane fade" id="file-tab-pane" role="tabpanel" aria-labelledby="file-tab" tabindex="0">
                                            <div class="form-item">
                                                ...
                                                <div class="form-text mt-3">
                                                    ...
                                                    <a class="badge badge--primary" href="{{route('demo.email.file.download', 'csv')}}"><i class="fa fa-download" aria-hidden="true"></i> {{ translate('csv')}}, </a>
                                                    <a class="badge badge--primary" href="{{route('demo.email.file.download', 'xlsx')}}"><i class="fa fa-download" aria-hidden="true"></i> {{ translate('xlsx')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
