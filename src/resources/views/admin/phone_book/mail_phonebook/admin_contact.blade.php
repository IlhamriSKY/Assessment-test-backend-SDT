                                    ...
                                    <table>
                                        ...
                                        @forelse($contacts as $contact)
                                            <tr class="@if($loop->even)@endif">
                                                ...
                                                <td data-label=" {{ translate('City')}}">
                                                    {{$contact->city}}
                                                </td>
                                                <td data-label=" {{ translate('Birthdate')}}">
                                                    {{ \Carbon\Carbon::parse($contact->birthdate)->format('m-d-Y') }}
                                                </td>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="city" name="city" placeholder=" {{ translate('Enter City')}}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="birthdate" class="form-label"> {{ translate('Birthdate')}} <sup class="text--danger">*</sup></label>
                                        <input type="date" class="form-control" id="birthdate" name="birthdate" placeholder=" {{ translate('Enter Birthdate')}}" required>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text"> {{ translate('Supported files: xlsx')}}</div>
                                        <div class="form-text"> {{ translate('Download file format from here')}}
                                            {{-- <a href="{{route('demo.email.file.download','xlsx')}}">{{ translate('exel')}}</a> --}}
        									<a href="{{url(env('APP_URL').'/assets/file/email/demo.xlsx')}}">{{ translate('exel')}}</a>
...
<script>
	(function($){
        ...
        $('.contact').on('click', function(){
            ...
            modal.find('input[name=birthdate]').val($(this).data('birthdate'));
            modal.find('select[name=status]').val($(this).data('status'));
            modal.modal('show');
        });
