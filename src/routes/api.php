...
Route::middleware('incoming.api')->name('incoming.')->group(function () {
    // Contact
    Route::get('get/contacts', [\App\Http\Controllers\Api\IncomingApi\UserController::class, 'getContacts'])->name('get.contacts');
    Route::get('get/contact/{id}', [\App\Http\Controllers\Api\IncomingApi\UserController::class, 'getContact'])->name('get.contact');
    Route::post('add/contact', [\App\Http\Controllers\Api\IncomingApi\UserController::class, 'addContact'])->name('add.contact');
    Route::put('edit/contact/{id}', [\App\Http\Controllers\Api\IncomingApi\UserController::class, 'editContact'])->name('edit.contact');
    Route::delete('delete/contact/{id}', [\App\Http\Controllers\Api\IncomingApi\UserController::class, 'deleteContact'])->name('delete.contact');
